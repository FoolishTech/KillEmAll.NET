...
{
    static class DigitalSig
    {
        // most of the code here is from pinvoke.net, I just added GetStatus and WinTrust.ReturnSignatureStatus
        // source:  http://www.pinvoke.net/default.aspx/wintrust.winverifytrust

        public static string GetStatus(string theFile)
        {
            string ret = "";
            
            try
            {
                ret = WinTrust.ReturnSignatureStatus(theFile);
            }
            catch
            {
                ret = "Error";
        ...
        sealed class WinTrust
        {
            ...
            // added to return specific signature status string
            public static string ReturnSignatureStatus(string fileName)
            {
